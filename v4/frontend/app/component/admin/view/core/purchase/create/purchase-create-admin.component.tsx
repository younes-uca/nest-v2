            ...
            <TabPanel header={{'TabPan' | translate}}>
                <div className="formgrid grid">
                    ...
                    <div className="field col-6">
                        ...
                        <Dropdown  id="clientDropdown"  value={item.client} options={clients} onChange={(e) => onDropdownChange(e, 'client')}   placeholder={{'ClientPlaceHolder' | translate}} filter filterPlaceholder={{'ClientPlaceHolderFilter' | translate}} optionLabel="fullName" showClear/>
                    </div>
                </div>
            </TabPanel>
            <TabPanel header={{'PurchaseItems' | translate}}>
                        <div className="grid">
                            <div className="field col-6">
                                ...
                                <Dropdown id="productDropdown" value={purchaseItems.product} options={products} onChange={(e) => onDropdownChangePurchaseItems(e, 'product')}    placeholder={{'ProductPlaceHolder' | translate}} filter filterPlaceholder={{'ProductPlaceHolderFilter' | translate}}  optionLabel="reference" showClear />
                             </div>
                            <div className="field col-6">
