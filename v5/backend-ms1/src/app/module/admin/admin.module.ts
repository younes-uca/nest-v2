...
@Module({
    imports: [TypeOrmModule.forFeature([  Purchase ,  PurchaseItem ,  Product ,  Client ,  ClientCategory , ])],
    controllers: [ PurchaseAdminRest ,  PurchaseItemAdminRest ,  ProductAdminRest ,  ClientAdminRest ,  ClientCategoryAdminRest ,  ],
