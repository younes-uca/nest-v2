        ...
        <div className="col-12">
            <div className="card">
                ...
                <Card title={t("search")} className="mb-5">
                        <div className="grid">
                            <div className="flex flex-column col-3">
                                <label className="mb-1"  htmlFor="1">{{'Reference' | translate}}</label>
                                <InputText id="1" value={criteria.reference} onChange={(e) => setCriteria({ ...criteria, reference: e.target.value })} />
                            </div>
                            <div className="flex flex-column col-3">
                                <label className="mb-1"  htmlFor="2-1">{{'PurchaseDateMin' | translate}}</label>
                            ...
                            <div className="flex flex-column col-3">
                                <label className="mb-1"  htmlFor="2-2">{{'PurchaseDateMax' | translate}}</label>
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as PurchaseDto[])} dataKey="id" className="datatable-responsive" globalFilter={globalFilter} header={header} responsiveLayout="scroll" >
                    ...
                    <Column field="reference" header={{'Reference' | translate}} sortable></Column>
                    
                    
                    <Column field="purchaseDate" header={{'PurchaseDate' | translate}} sortable body={formateDate("purchaseDate")}></Column>
                    
                    
                    <Column field="image" header={{'Image' | translate}} sortable></Column>
                    
                    
                    <Column field="total" header={{'Total' | translate}} sortable></Column>
                    
                    
                    <Column field="client.fullName" header={{'Client' | translate}} sortable ></Column>
