        ...
        <div className="col-12">
            <div className="card">
                ...
                <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as ClientDto[])} dataKey="id" className="datatable-responsive" globalFilter={globalFilter} header={header} responsiveLayout="scroll" >
                    ...
                    <Column field="fullName" header={{'FullName' | translate}} sortable></Column>
                    
                    
                    <Column field="email" header={{'Email' | translate}} sortable></Column>
                    
                    
                    <Column field="clientCategory.reference" header={{'ClientCategory' | translate}} sortable ></Column>
