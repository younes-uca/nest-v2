...
export class AbstractController<T extends AuditBusinessObject, DTO extends BaseDto, Criteria extends BaseCriteria, REPO extends AbstractRepository<T>, SERV extends AbstractServiceImpl<T, Criteria, REPO>, > {
